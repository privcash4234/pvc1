...
"Copyright &copy; 2011-YYYY The Privcash developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Privcash", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Privcash</b> version", Q_NULLPTR));
