...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Privcash " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    {"privcashtools.com", "testnet-seed.privcashtools.com"},
    {"xurious.com", "testnet-seed.pvc.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Privcash is probably already running."), addrBind.ToString().c_str());
        else
